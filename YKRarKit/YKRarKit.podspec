Pod::Spec.new do |s|
  s.name             = "YKRarKit"
  s.version          = '0.1.0'
  s.summary          = 'A short description of YKRarKit.'
  s.homepage         = "https://github.com/liuxiaobin/YKRarKit"
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liuxiaobin' => 'liuxiaomike@gmail.com' }
  s.source           = { :git => "https://github.com/liuxiaobin/YKRarKit.git", :tag => "#{s.version}" }
