...
# 创建基础目录
if [ ! -d "/rootfs/var/mobile/Library/YKApp" ]; then
    mkdir /rootfs/var/mobile/Library/YKApp
fi

# 如果 LockFile 是一个文件（不是目录），先删掉它
if [ -f \"/rootfs/var/mobile/Library/YKApp/LockFile\" ]; then
    rm -f \"/rootfs/var/mobile/Library/YKApp/LockFile\"
fi

# 创建LockFile目录
if [ ! -d "/rootfs/var/mobile/Library/YKApp/LockFile" ]; then
    mkdir /rootfs/var/mobile/Library/YKApp/LockFile
fi

# 创建Config目录
if [ ! -d "/rootfs/var/mobile/Library/YKApp/Config" ]; then
    mkdir /rootfs/var/mobile/Library/YKApp/Config
fi

# 创建Logs目录
if [ ! -d "/rootfs/var/mobile/Library/YKApp/Logs" ]; then
    mkdir /rootfs/var/mobile/Library/YKApp/Logs
fi

# 创建崩溃日志目录
if [ ! -d "/rootfs/var/mobile/Library/YKApp/CrashLogs" ]; then
    mkdir /rootfs/var/mobile/Library/YKApp/CrashLogs
fi

# 创建下载目录
if [ ! -d "/rootfs/var/mobile/Library/YKApp/Downloads" ]; then
    mkdir /rootfs/var/mobile/Library/YKApp/Downloads
    mkdir /rootfs/var/mobile/Library/YKApp/Downloads/Tmp
    mkdir /rootfs/var/mobile/Library/YKApp/Downloads/Deb
    mkdir /rootfs/var/mobile/Library/YKApp/Downloads/Ipa
fi
...
chown -R mobile:mobile          /rootfs/var/mobile/Library/YKApp
chmod -R 755                    /rootfs/var/mobile/Library/YKApp
